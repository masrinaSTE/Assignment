...
//            Log.e("logout", "Sign ouuuuutttt");
//            signOut();
//        }
        Log.e("login agaiiiiiinnn", "alksfhdoiwhvkns");
...
//        }
    ...
    protected void updateConnectButtonState() {
        ...
        final boolean connected = getPlusClient().isConnected();
...
//            }
            if (success) {
                sessionManagement.createLoginSession("Admin", "admin@gmail.com");
                Intent i = new Intent(getApplicationContext(), MainActivity.class);
                startActivity(i);
                Toast.makeText(getApplicationContext(), "Log In Success",
                        Toast.LENGTH_SHORT).show();
